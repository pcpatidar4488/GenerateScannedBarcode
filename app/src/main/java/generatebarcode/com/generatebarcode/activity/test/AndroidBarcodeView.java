...
public class AndroidBarcodeView extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        try {
            ...
            if (type == generatebarcode.com.generatebarcode.utils.IBarcode.CODE128){
                testCODE128(canvas);
            }else if (type == generatebarcode.com.generatebarcode.utils.IBarcode.CODE39){
                testCODE39(canvas);
            }else if (type == generatebarcode.com.generatebarcode.utils.IBarcode.CODE93){
                testCODE93(canvas);
            }else if (type == generatebarcode.com.generatebarcode.utils.IBarcode.EAN13){
                testEAN13(canvas);
            }else if (type == generatebarcode.com.generatebarcode.utils.IBarcode.EAN8){
                testEAN8(canvas);
            }else if (type == generatebarcode.com.generatebarcode.utils.IBarcode.CODABAR){
                testCODABAR(canvas);
            }else if (type == generatebarcode.com.generatebarcode.utils.IBarcode.UPCE){
                testUPCE(canvas);
            }else if (type == generatebarcode.com.generatebarcode.utils.IBarcode.UPCA){
                testUPCA(canvas);
            }else if (type == generatebarcode.com.generatebarcode.utils.IBarcode.ITF){
                 testITF14(canvas);
            }
            //testCODE11(canvas);
            //testCODE2OF5(canvas);
    ...
    private static void testCODABAR(Canvas canvas) throws Exception {
       ...
       // barcode.setData("112233445566");
        ...
        barcode.setUom(generatebarcode.com.generatebarcode.utils.IBarcode.UOM_PIXEL);
    ...
    private static void testDataMatrix(Canvas canvas) throws Exception {
        ...
        */
        ...
        barcode.setFnc1Mode(generatebarcode.com.generatebarcode.utils.IBarcode.FNC1_NONE);
